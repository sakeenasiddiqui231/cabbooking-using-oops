    ...
    <div class="dropdown-content">
     ...
     <section class="img">
         ...
         <img src="logo2.png" height="55px" width="75px" style="margin-left:630px;margin-top:30px;">
             <h1 id="h1"> All the Pending Rides</h1>
             <div class="muser">
             ...
             <?php
                ...
                if (isset($_GET['id'])) {
                    ...
                    $sql = 'UPDATE tbl_ride SET `status`="0" WHERE `cus_user_id`="'.$c_id.'"';
                    $result = mysqli_query($data->con, $sql); 
                }
           ...
           ?>
             ...
             <table>
                <thead>
                    ...
                    <th>Ride Date</th>
                    <th>
                        <a href="pendingrides.php?ride_d=ASC" style="color:white;">Asc</a>
                        <a href="pendingrides.php?ride_d=DESC" style="color:white;">DESC</a>
                    </th>
                    <th>To</th>
                    <th>From</th>
                    <th>Total Distance</th>
                    <th>
                        <a href="pendingrides.php?distance=ASC" style="color:white;">Asc</a>
                        <a href="pendingrides.php?distance=DESC" style="color:white;">DESC</a>
                    </th>
                    <th>Luggage</th>
                    <th>Total Fare</th>
                    <th>
                        <a href="pendingrides.php?fare=ASC" style="color:white;">Asc</a>
                        <a href="pendingrides.php?fare=DESC" style="color:white;">DESC</a>
                    </th>
                    <th>Cus_User_Id</th>
                ...
                <tbody>
                    ...
                    if( mysqli_num_rows( $selectRes )==0 ){
                        ...
                        echo "<tr>
                                ...
                                <td><a href='pendingrides.php?id={$row['ride_id']}'><input type='submit' value='Approve' id='editbtn1'></a>
                                <td><a href='pendingrides.php?cid={$row['cus_user_id']}'><input type='submit' value='Cancel' id='editbtn2'></a>

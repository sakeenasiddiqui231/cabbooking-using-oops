    ...
    <div class="dropdown-content">
     ...
     <section class="img">
         ...
         <img src="logo2.png" height="55px" width="75px" style="margin-left:630px;margin-top:40px;">
             <h1 id="h1"> All the Completed Rides</h1>
             <div class="muser">
           ...
           ?>
             ...
             <table>
                <thead>
                    ...
                    <th>
                        <a href="completedrides.php?distance=ASC" style="color:white;">ASC</a>
                        <a href="completedrides.php?distance=DESC" style="color:white;">DESC</a>
                    </th>
                    <th>Luggage</th>
                    <th>Total Fare</th>
                    <th>
                        <a href="completedrides.php?fare=ASC" style="color:white;">ASC</a>
                        <a href="completedrides.php?fare=DESC" style="color:white;">DESC</a>
                    </th>
                    <th>Cus_User_Id</th>
                    <th>Action</th>
                ...
                <tbody>
                    ...
                    if( mysqli_num_rows( $selectRes )==0 ){
                        ...
                        echo "<tr>
                                ...
                                <td><a href='invoice.php?id=".$row['ride_id']."&rd=".$row['ride_date']."&from=".$row['from']."&to=".$row['to']."&total_d=".$row['total_distance']."&total_l=".$row['luggage']."&total_f=".$row['total_fare']."&cui=".$row['cus_user_id']."' ><input type='submit' value='Invoice' id='editbtn1'></a></td>
